...
Then ask the human to enter the exact requested version `${1:-<x.y.z-preview.n>}` to authorize public publication. A generic yes, a different version, empty response, or decline is not confirmation.
